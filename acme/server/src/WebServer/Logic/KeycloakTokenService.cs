...
public class KeycloakTokenService : IKeycloakTokenService
{
    ...
    {
        var tokenEndpoint = "http://localhost:8080/realms/acme/protocol/openid-connect/auth?client_id=monolith-client&response_type=code&scope=openid&redirect_uri=http://localhost:8080/realms/acme/broker/MonolithOidc/endpoint";
